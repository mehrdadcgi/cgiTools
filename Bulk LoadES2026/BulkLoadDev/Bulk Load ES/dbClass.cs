...
public class DbClass
    ...
    private static void ApplyCommandTimeout(SqlCommand cmd)
    {
       ...
       // System.Configuration.ConfigurationManager.
        ...
        public DataSet GetDataSet(string sql, string table)
        {
            ...
            try
            {
                ...
                ApplyCommandTimeout(sqlAdap.SelectCommand);
        ...
        public DataSet GetDataSet(string sql)
        {
            ...
            catch (Exception ex)
            {
               // new ExceptionOx(ex);
                //sqlError=ex.ToString()+"<br>"+sql;
                ConsoleAppES.helper.OutMsg(ex.Message);
                // HttpContext.Current.Response.Write(sqlError);
            }
            myConnection.Close();
            return ds;
